...
//        fetch('https://iotdatahub.online/iot_lk/api/user/share_dataset', {
        fetch('http://127.0.0.1:5000/api/user/share_dataset', {
            method: 'POST',
            headers: {
...
//        fetch('https://iotdatahub.online/iot_lk/token/info', {
        fetch('http://127.0.0.1:5000/token/info', {
            method: 'GET',
            headers: {
...
//            const response = await fetch('https://iotdatahub.online/iot_lk/api/user/view_all_available_datasets', {
            const response = await fetch('http://127.0.0.1:5000/api/user/view_all_available_datasets', {
                method: 'GET',
                headers: {
                    'Authorization': `Bearer ${token}`,
                }
...
//            const response1 = await fetch('https://iotdatahub.online/iot_lk/api/get_user_id', {
            const response1 = await fetch('http://127.0.0.1:5000/api/get_user_id', {
                method: 'GET',
                headers: {
                    'Authorization': 'Bearer ' + token
                }
...
//        fetch('https://iotdatahub.online/iot_lk/api/dataset/add_new_dataset', {
        fetch('http://127.0.0.1:5000/api/dataset/add_new_dataset', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + token
...
//        fetch('https://iotdatahub.online/iot_lk/api/device/add_new_device', {
        fetch('http://127.0.0.1:5000/api/device/add_new_device', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer ' + token 
...
//                http://iotdatahub.online/iot_lk/api/device/collect_device_data<br>
                http://127.0.0.1:5000/api/device/collect_device_data<br>
...
//                http://iotdatahub.online/iot_lk/api/device/collect_device_data?device_id=${data.device_id}&key=${data.key}&value=0<br><br>
                http://127.0.0.1:5000/api/device/collect_device_data?device_id=${data.device_id}&key=${data.key}&value=0<br><br>                
...
//                fetch(`https://iotdatahub.online/iot_lk/api/device/collect_device_data?device_id=${data.device_id}&key=${data.key}&value=0`)
                fetch(`http://127.0.0.1:5000/api/device/collect_device_data?device_id=${data.device_id}&key=${data.key}&value=0`)
                .then(response => response.json())
                .then(data => {
...
//        fetch(`https://iotdatahub.online/iot_lk/api/user/view_dataset_data?dataset_id=${datasetId}`, {
        fetch(`http://127.0.0.1:5000/api/user/view_dataset_data?dataset_id=${datasetId}`, {
            headers: {
                'Authorization': 'Bearer ' + localStorage.getItem('token')
            }
        })
...
//        fetch(`https://iotdatahub.online/iot_lk/api/user/view_dataset_data?dataset_id=${datasetId}`, {
        ...
        function performAnalysis() {
            ...
            if (selectedMethod === 'median') {
                url = `/api/analytics/median/?device_id=${deviceId}`;
            } else if (selectedMethod === 'mean') {
                url = `/api/analytics/arithmetic_mean/?device_id=${deviceId}`;
            } else if (selectedMethod === 'geom_mean') {
                url = `/api/analytics/geometric_mean/?device_id=${deviceId}`;
            } else if (selectedMethod === 'sq-mean') {
                url = `/api/analytics/root_mean_square/?device_id=${deviceId}`;
            } else if (selectedMethod === 'min') {
                url = `/api/analytics/min_value/?device_id=${deviceId}`;
            } else if (selectedMethod === 'max') {
                url = `/api/analytics/max_value/?device_id=${deviceId}`;
            } else if (selectedMethod === 'standard-dev') {
                url = `/api/analytics/standard_deviation/?device_id=${deviceId}`;
                ...
                url = `/api/analytics/correlation_coefficient/?x_device_id=${deviceId}&y_device_id=${secondDeviceId}`;
            } else if (selectedMethod === 'regr') {
                ...
                url = `/api/analytics/regression_analysis/?device_id=${deviceId}&horizon_value=${horizonValue}`;
            }
